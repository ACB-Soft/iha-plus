...
const Onboarding: React.FC<Props> = ({ onFinish }) => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-200 h-full animate-in overflow-hidden px-8 pt-12 pb-6">
      ...
      {/* Dosya ve İnternet Erişimi - Başlığın bir satır altında */}
      <div className="flex flex-col items-center w-full max-w-sm mx-auto space-y-2.5 md:space-y-3 mb-auto">
      ...
      {/* Uygulamaya Başla - Marka bilgisinin (footer) bir satır üstünde */}
      <div className="w-full max-w-sm mx-auto shrink-0 mt-8">
        <button 
